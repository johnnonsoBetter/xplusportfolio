...
//the function to call the push server: https://github.com/Spyna/push-notification-demo/blob/master/front-end-react/src/utils/authAxios.js
...
export default function usePushNotifications() {
  ...
  const onClickSendNotification = async () => {
    setLoading(true);
    setError(false);
    await authAxios.get(`/subscription/${pushServerSubscriptionId}`).catch(err => {
      setLoading(false);
      setError(err);
    });
    setLoading(false);
