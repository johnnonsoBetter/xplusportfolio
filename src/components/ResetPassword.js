...
import { BadgeRounded, CloseOutlined, KeyRounded, Visibility, VisibilityOff } from '@mui/icons-material';
                ...
                <Box  width="100%">
                    <Paper elevation={0}  >
                        ...
                        <Box p={2}  textAlign="center" display="flex" justifyContent="center" m={5} marginBottom={0} >
                             ...
                             <Avatar > <KeyRounded /> </Avatar>

                        </Box>
                        <Box p={2} textAlign="center"  >
                             <Typography variant="h6" sx={{letterSpacing: "0em", fontWeight: "450"}}> Reset Password</Typography>
