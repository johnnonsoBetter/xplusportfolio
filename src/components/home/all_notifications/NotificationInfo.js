...
export default function NotificationInfo({ markAsSeen, link, body, title, icon, backgroundColor}) {
    ...
    return (
            ...
            <ListItemButton disableGutters disableRipple  onClick={() => {
                ...
                history.push(link)
                    ...
                    <Avatar   style={{width: "42px", height: "42px"}} sx={{backgroundColor: backgroundColor}} sizes='large' >
